...
/* Texto markdown dentro de la app (sin !important para no dañar ventanas flotantes) */
...
# ======================================================
# FIX FINAL – TEXTO BLANCO EN VENTANAS FLOTANTES
# ======================================================
# Este bloque va al final del archivo para ganarle a cualquier CSS previo.
st.markdown(
    """
    <style>
    /* Botón de ayuda: fondo azul y letra blanca */
    div[data-testid="stDownloadButton"] > button,
    div[data-testid="stDownloadButton"] > button *,
    div[data-testid="stDownloadButton"] button,
    div[data-testid="stDownloadButton"] button * {
    ...
    /* Fondo exterior del modal: transparente con oscurecimiento suave */
    div[data-baseweb="modal"],
    div[data-testid="stDialog"],
    div[data-testid="stModal"],
    [aria-modal="true"] {
    ...
    /* Caja azul oscuro de la ventana flotante */
    div[data-baseweb="modal"] div[role="dialog"],
    ...
    /* Regla general: cualquier texto dentro del modal debe ser blanco */
    div[data-baseweb="modal"] div[role="dialog"] *,
    div[data-testid="stDialog"] div[role="dialog"] *,
    div[data-testid="stModal"] div[role="dialog"] *,
    div[role="dialog"] *,
    ...
    /* Formularios e inputs dentro del modal */
    div[data-baseweb="modal"] div[data-testid="stForm"],
    div[role="dialog"] div[data-testid="stForm"],
    section[role="dialog"] div[data-testid="stForm"] {
        background: transparent !important;
        background-color: transparent !important;
        border: 1px solid rgba(148, 163, 184, 0.45) !important;
        border-radius: 10px !important;
    ...
    div[role="dialog"] input::placeholder,
    section[role="dialog"] input::placeholder,
    [aria-modal="true"] input::placeholder {
        color: #CBD5E1 !important;
        -webkit-text-fill-color: #CBD5E1 !important;
        opacity: 1 !important;
    }
    ...
    /* Nota de lectura rápida */
    div[data-baseweb="modal"] .modal-note,
    div[role="dialog"] .modal-note,
    section[role="dialog"] .modal-note {
        background: #1E497D !important;
        background-color: #1E497D !important;
        border-radius: 14px !important;
        padding: 22px 24px !important;
