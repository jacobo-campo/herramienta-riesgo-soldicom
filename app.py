...
/* Todo texto dentro de las ventanas flotantes */
div[role="dialog"] *,
div[data-baseweb="modal"] *,
[data-testid="stDialog"] *,
[data-testid="stModal"] * {{
...
/* Markdown dentro de los modales: evita que la regla global .stMarkdown lo ponga azul oscuro */
div[role="dialog"] .stMarkdown,
div[role="dialog"] .stMarkdown *,
div[role="dialog"] [data-testid="stMarkdownContainer"],
div[role="dialog"] [data-testid="stMarkdownContainer"] *,
div[data-baseweb="modal"] .stMarkdown,
div[data-baseweb="modal"] .stMarkdown *,
...
div[data-baseweb="modal"] .modal-note strong,
...
# Cuando se cambia de paso, fuerza la vista al inicio de la página.
# Esto evita que la app quede ubicada abajo después de Volver, Modificar respuestas o Finalizar.
