...
/* Capa de fondo: deja ver el aplicativo detrás del modal */
...
# Fuerza la vista al inicio de la página en cada carga y después de cada cambio de paso.
...
def build_pdf_report(
    ...
    def draw_header():
        ...
        line_y = y - header_used_height - 14
        c.setStrokeColor(LIGHT_LINE)
