...
# ======================================================
# CSS FINAL V3 - MODALES Y BOTÓN DE AYUDA
# Se ubica al final de los estilos para ganar prioridad.
# ======================================================
st.markdown("""
<style>
/* Botón Modo de Uso - Ayuda: letra blanca siempre */
div[data-testid="stDownloadButton"] button,
div[data-testid="stDownloadButton"] button *,
div[data-testid="stDownloadButton"] p,
div[data-testid="stDownloadButton"] span {
...
/* Fondo exterior de los diálogos: transparente con velo gris, no azul sólido */
div[data-baseweb="modal"],
div[data-testid="stDialog"],
div[data-testid="stModal"] {
    background: transparent !important;
...
/* Capa oscura suave que deja ver la herramienta detrás */
div[data-baseweb="modal"] > div:first-child,
div[data-testid="stDialog"]::before,
div[data-testid="stModal"]::before {
    background: rgba(15, 23, 42, 0.34) !important;
...
/* Caja flotante del diálogo: azul oscuro sólido */
div[data-baseweb="modal"] div[role="dialog"],
...
div[role="dialog"] {
    ...
    border-radius: 22px !important;
    border: 1px solid rgba(148, 163, 184, 0.55) !important;
    box-shadow: 0 18px 45px rgba(15, 23, 42, 0.45) !important;
}

/* Texto general del diálogo: blanco forzado con máxima prioridad */
div[data-baseweb="modal"] div[role="dialog"] *,
div[data-testid="stDialog"] div[role="dialog"] *,
div[role="dialog"] *,
div[role="dialog"] h1,
