...
/* Contenedor del modal: transparente para que se vea el aplicativo detrás */
...
/* Evita que algún contenedor interno pinte toda la pantalla de azul oscuro */
...
[data-testid="stDialog"] div[data-testid="stMarkdownContainer"],
[data-testid="stDialog"] div[data-testid="stMarkdownContainer"] * {{
    color: #F8FAFC !important;
    opacity: 1 !important;
}}
    ...
    components.html(
        ...
        const forceTop = () => {
            try {
                ...
                // 1. Intentar mover la ventana principal.
                window.parent.scrollTo(0, 0);
                doc.documentElement.scrollTop = 0;
                doc.body.scrollTop = 0;

                // 2. Intentar mover los contenedores internos de Streamlit.
                const selectors = [
                ...
                // 3. Usar el ancla superior de la app.
        ...
        forceTop();
        [50, 150, 350, 700, 1200, 2000].forEach((t) => setTimeout(forceTop, t));
        </script>
        """,
        height=0,
    )
