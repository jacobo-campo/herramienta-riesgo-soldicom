...
#    st.title("Herramienta de identificación de riesgos de pérdida de competencia")
    ...
    try:
        ...
        guia_pdf_base64 = base64.b64encode(guia_pdf).decode("utf-8")

        st.markdown(
            f"""
            <a href="data:application/pdf;base64,{guia_pdf_base64}"
               target="_blank"
...
def build_pdf_report(
    ...
    # Se conserva únicamente el número de competidores identificados.
    # La lista detallada de competidores no se muestra en el reporte PDF.
...
#    st.header("Ingreso de información del contrato")
    ...
    if st.session_state.eds_info is not None:
        ...
        # Lista detallada de competidores oculta a solicitud del usuario.
        st.markdown('<hr class="soft-hr"/>', unsafe_allow_html=True)
